...
// "message".
func buildDefaultPayload(subject, message string) any { _ = "STUB: not implemented"; return *new(any) }
...
func (s *Service) AddReceiversURLs(urls ...string) { _ = "STUB: not implemented"; return }
...
func (s *Service) WithClient(client *http.Client) { _ = "STUB: not implemented"; return }

// doPreSendHooks executes all the pre-send hooks. If any of the hooks returns an error, the execution is stopped and
// the error is returned.
func (s *Service) doPreSendHooks(req *http.Request) error { _ = "STUB: not implemented"; return nil }
...
func (s *Service) PreSend(hook PreSendHookFn) { _ = "STUB: not implemented"; return }

// PostSend adds a post-send hook to the service. The hook will be executed after sending a request to a receiver.
func (s *Service) PostSend(hook PostSendHookFn) { _ = "STUB: not implemented"; return }
